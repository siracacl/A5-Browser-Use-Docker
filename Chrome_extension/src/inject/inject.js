(function () {
  ...
  function injectPanel() {
    ...
    const advancedSettingsBtn = shadowRoot.getElementById(
      "advancedSettingsBtn"
    );
    const advancedSettingsContainer = shadowRoot.getElementById(
      "advancedSettingsContainer"
    );
    const advancedSettingsTextarea = shadowRoot.getElementById(
    ...
    advancedSettingsBtn.addEventListener("click", (e) => {
      ...
      const currentlyActive =
        advancedSettingsContainer.classList.contains("active");
      if (currentlyActive) {
        advancedSettingsContainer.classList.remove("active");
  ...
  // ----------------------------------------
  // 12. Make the toggle button draggable on Y-axis
  // ----------------------------------------
